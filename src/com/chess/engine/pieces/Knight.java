...
import static com.chess.engine.utils.PiecePositions.ALL_BN_POSITIONS_CACHE;
import static com.chess.engine.utils.PiecePositions.ALL_WN_POSITIONS_CACHE;
...
public class Knight extends Piece {
    ...
    /**
     * Creates a knight with a piece alliance and a piece position.
     *
    ...
    public Knight movePiece(final Move move) {
        return this.pieceAlliance.isBlack() ? (Knight) ALL_BN_POSITIONS_CACHE.get(move.getDestinationIndex()) :
                                              (Knight) ALL_WN_POSITIONS_CACHE.get(move.getDestinationIndex());
    }
