...
import static com.chess.engine.utils.PiecePositions.ALL_BK_POSITIONS_CACHE;
import static com.chess.engine.utils.PiecePositions.ALL_WK_POSITIONS_CACHE;
...
public class King extends Piece {
    ...
    /**
     * Creates a king with a piece alliance and a piece position.
     *
    ...
    public King movePiece(final Move move) {
        return this.pieceAlliance.isBlack() ? (King) ALL_BK_POSITIONS_CACHE.get(move.getDestinationIndex()) :
                                              (King) ALL_WK_POSITIONS_CACHE.get(move.getDestinationIndex());
    }
