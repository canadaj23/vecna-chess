...
import static com.chess.engine.utils.PiecePositions.ALL_BP_POSITIONS_CACHE;
import static com.chess.engine.utils.PiecePositions.ALL_WP_POSITIONS_CACHE;
...
public class Pawn extends Piece {
    ...
    /**
     * Creates a pawn with a piece alliance and a piece position.
     *
    ...
    public Pawn movePiece(final Move move) {
        return this.pieceAlliance.isBlack() ? (Pawn) ALL_BP_POSITIONS_CACHE.get(move.getDestinationIndex()) :
                                              (Pawn) ALL_WP_POSITIONS_CACHE.get(move.getDestinationIndex());
    }
