...
public class Rook extends Piece {
    ...
    /**
     * Creates a rook with a piece alliance and a piece position.
     *
    ...
    public Rook movePiece(final Move move) {
        return this.pieceAlliance.isBlack() ? (Rook) ALL_BR_POSITIONS_CACHE.get(move.getDestinationIndex()) :
                                              (Rook) ALL_WR_POSITIONS_CACHE.get(move.getDestinationIndex());
    }
