...
import static com.chess.engine.utils.PiecePositions.ALL_BQ_POSITIONS_CACHE;
import static com.chess.engine.utils.PiecePositions.ALL_WQ_POSITIONS_CACHE;
...
public class Queen extends Piece {
    ...
    /**
     * Creates a queen with a piece alliance and a piece position.
     *
    ...
    public Queen movePiece(final Move move) {
        return this.pieceAlliance.isBlack() ? (Queen) ALL_BQ_POSITIONS_CACHE.get(move.getDestinationIndex()) :
                                              (Queen) ALL_WQ_POSITIONS_CACHE.get(move.getDestinationIndex());
    }
