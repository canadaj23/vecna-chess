...
public class DimensionConstants {
    ...
    private static final int DEFAULT_TAKEN_PIECES_PANEL_WIDTH = 40, DEFAULT_TAKEN_PIECES_PANEL_HEIGHT = 80;
    private static final int TAKEN_PIECES_PANEL_WIDTH = (int) (DEFAULT_TAKEN_PIECES_PANEL_WIDTH * SCALE);
    private static final int TAKEN_PIECES_PANEL_HEIGHT = (int) (DEFAULT_TAKEN_PIECES_PANEL_HEIGHT * SCALE);

    private static final int DEFAULT_GAME_HISTORY_PANEL_WIDTH = 100, DEFAULT_GAME_HISTORY_PANEL_HEIGHT = 400;
    private static final int GAME_HISTORY_PANEL_WIDTH = (int) (DEFAULT_GAME_HISTORY_PANEL_WIDTH * SCALE);
    private static final int GAME_HISTORY_PANEL_HEIGHT = (int) (DEFAULT_GAME_HISTORY_PANEL_HEIGHT * SCALE);
    ...
    public static final Dimension TAKEN_PIECES_PANEL_DIMENSION = new Dimension(TAKEN_PIECES_PANEL_WIDTH,
                                                                               TAKEN_PIECES_PANEL_HEIGHT);
    public static final Dimension GAME_HISTORY_PANEL_DIMENSION = new Dimension(GAME_HISTORY_PANEL_WIDTH,
                                                                               GAME_HISTORY_PANEL_HEIGHT);
}
